<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InserisciPatologia.aspx.cs" Inherits="WebAppMed3.InserisciPatologia" %>
            ...
            <section class="container content-container">
                <form runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtdescrizione" runat="server" class="form-control" Rows="5" TextMode="MultiLine"></asp:TextBox>
                    </div>
